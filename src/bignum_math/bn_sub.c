...
static ATTR_NONNULL bignum_i *subtract(bignum_i *const n1, bignum_i *const n2);
 ...
 */
static bignum_i *subtract(bignum_i *const n1, bignum_i *const n2)
{
 ...
 * Return: pointer to the result, NULL on failure.
 */
static bignum_i *subtract_negatives(bignum_i *const n1, bignum_i *const n2)
{
...
/**
 * bni_subtract - handle subtraction of two bignums.
 * @n1: first number.
 * @n2: second number.
 *
 * Return: pointer to the result, NULL on failure.
