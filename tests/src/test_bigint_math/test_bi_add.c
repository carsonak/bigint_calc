...
{
	bigint *output = bi_add(NULL, NULL);
	 ...
	 .description = "1 + NULL = NULL", .timeout = 1.0)
{
	...
	bigint *output = bi_add(&num1, NULL);
	 ...
	 .description = "NULL + 1 = NULL", .timeout = 1.0)
{
	...
	num2.num = in2;
	bigint *output = bi_add(NULL, &num2);
	 ...
	 .description = "0 + 0 = 0", .timeout = 1.0)
{
	...
	expected.num = out;
	bigint *output = bi_add(&num1, &num1);
...
{
	u_int in1[] = {bi_BASE - 1}, in2[] = {1}, out[] = {0, 1};
...
Test(long_additions, test_999999999999999999_plus_999999999,
	 ...
	 .timeout = 1.0)
{
	u_int in1[] = {bi_BASE - 1, bi_BASE - 1}, in2[] = {bi_BASE - 1};
...
Test(long_additions, test_long9s_plus_1,
	 ...
	 .timeout = 1.0)
{
	u_int in1[] = {bi_BASE - 1, bi_BASE - 1, bi_BASE - 1, bi_BASE - 1, bi_BASE - 1};
	u_int in2[] = {1};
...
{
	u_int in1[] = {1};
	u_int in2[] = {bi_BASE - 1, bi_BASE - 1, bi_BASE - 1, bi_BASE - 1, bi_BASE - 1};
	u_int out[] = {0, 0, 0, 0, 0, 1};
