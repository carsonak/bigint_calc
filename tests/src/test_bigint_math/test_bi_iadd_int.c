...
{
	cr_expect(zero(chr, bi_iadd_int(NULL, 0)));
}

Test(null_inputs, test_null_plus_1,
	 .description = "NULL + 1 = NULL", .timeout = 1.0)
{
	cr_expect(zero(chr, bi_iadd_int(NULL, 1)));
}
...
{
	cr_expect(zero(chr, bi_iadd_int(&num1, 0)));
}
	 ...
	 .description = "1 + 999999999, 999999999 = 1, 0, 0", .timeout = 1.0)
{
	...
	bi_iadd_int(&num1, 999999999999999999);
