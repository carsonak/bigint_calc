...
{
	cr_expect(zero(chr, bi_isubtract_int(NULL, 0)));
}

Test(null_inputs, test_null_minus_1,
	 .description = "NULL - 1 = NULL", .timeout = 1.0)
{
	cr_expect(zero(chr, bi_isubtract_int(NULL, 1)));
}
...
Test(zero_len_arrays, test_nullarray_minus_nullarray,
	 .description = "null_array - 0 = (invalid input)", .timeout = 1.0)
{
	cr_expect(zero(chr, bi_isubtract_int(&num1, 0)));
}
...
Test(zero_len_arrays, test_nullarray_minus_largenum,
	 ...
	 .timeout = 1.0)
{
	cr_expect(zero(chr, bi_isubtract_int(&num1, 490998)));
}
...
Test(negative_subtractions, test_5_minus_minus1,
	 .description = "5 - -1 = 6 (does addition)", .timeout = 1.0)
{
