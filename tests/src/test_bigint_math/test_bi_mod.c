...
{
	bigint *output = bi_modulo(NULL, NULL);
	 ...
	 .description = "1 % NULL = NULL", .timeout = 1.0)
{
	...
	num1.num = in1;
	bigint *output = bi_modulo(&num1, NULL);
	 ...
	 .description = "NULL % 1 = NULL", .timeout = 1.0)
{
	...
	num2.num = in2;
	bigint *output = bi_modulo(NULL, &num2);
	 ...
	 .timeout = 1.0)
{
	...
	bigint *output = bi_modulo(&num1, &num2);
...
Test(division_by_zero, test_0_mod_0,
	 .description = "0 / 0 = NULL", .timeout = 1.0)
{
...
Test(division_by_zero, test_1_mod_0,
	 .description = "1 / 0 = NULL", .timeout = 1.0)
{
	u_int in1[] = {1}, in2[1] = {0};
...
Test(large_modulus, test_o500d_modulo_o500e,
	 .description = "o_500.d % o_500.e = medium_large3", .timeout = 1.0)
{
...
Test(large_modulus, test_o100a_modulo_o100f,
	 .description = "o_100.a % o_100.f = long_num", .timeout = 1.0)
{
...
Test(large_modulus, test_o100f_modulo_o100a,
	 .description = "o_100.f % o_100.a = long_num2", .timeout = 1.0)
{
