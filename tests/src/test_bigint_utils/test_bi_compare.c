...
{
	cr_assert(zero(long, bi_compare(NULL, NULL)));
}
	 ...
	 .description = "compare(0, NULL) == 0", .timeout = 1.0)
{
	...
	num1.num = in1;
	cr_assert(zero(long, bi_compare(&num1, NULL)));
}
	 ...
	 .description = "compare(NULL, 0) == 0", .timeout = 1.0)
{
	...
	num1.len = sizeof(in1) / sizeof(*in1);
	num1.num = in1;
	cr_assert(zero(long, bi_compare(NULL, &num1)));
}
...
{
	cr_assert(zero(long, bi_compare(NULL, &num2)));
}
...
{
	cr_assert(zero(long, bi_compare(&num1, &num2)));
}
	 ...
	 .description = "compare(0, null_array) == 1", .timeout = 1.0)
{
	...
	num1.len = sizeof(in1) / sizeof(*in1);
	num1.num = in1;
	cr_assert(eq(long, bi_compare(&num1, &num2), 1));
}
	 ...
	 .description = "compare(long_array0, short_array0) > 0", .timeout = 1.0)
{
	...
	cr_assert(gt(long, bi_compare(&num1, &num2), 0));
}
	 ...
	 .description = "compare(0, 1) < 0", .timeout = 1.0)
{
	...
	cr_assert(lt(long, bi_compare(&num1, &num2), 0));
}
