...
Test(simple_additions, test_12345_plus_54321,
	 .description = "12345 + 54321 = 66666", .timeout = 2.0)
{
...
Test(simple_additions, test_54321_plus_12345,
	 .description = "54321 + 12345 = 66666", .timeout = 2.0)
{
...
Test(long_additions, test_999999999_plus_1,
	 .description = "999,999,999 + 1 = 1,000,000,000", .timeout = 2.0)
{
