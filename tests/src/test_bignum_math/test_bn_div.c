...
Test(zero_len_arrays, test_nullarray_over_nullarray,
	 .description = "null_array / null_array = NULL", .timeout = 1.0)
{
	cr_redirect_stderr();
...
Test(zero_len_arrays, test_4490998_over_nullarray,
	 .description = "4,490,998 / null_array = NULL", .timeout = 1.0)
{
	u_int in1[] = {4490998};
...
Test(simple_divisions, test_9723746_over_2938487,
	 .description = "9723746 / 2938487 = 3", .timeout = 1.0)
{
