...
Test(zero_len_arrays, test_4490998_over_nullarray,
	 .description = "4,490,998 / null_array = NULL", .timeout = 2.0)
{
	uint in1[] = {4490998};
...
Test(simple_divisions, test_longnum1_over_longnum2,
	 .description = "2100, 550005550, 0, 45000, 5, 65000 / 75006, 0 = "
					"28005092, 999893341, 865984055, 208916620",
	 .timeout = 2.0)
{
...
Test(large_divisions, test_o100a_over_o100f, .description = "o_100.a / o_100.f = long_num", .timeout = 2.0)
{
	...
	uint out[] = {467911615, 986420336, 456339159, 762062729, 530481552, 890502739, 598230926, 265770966, 42977542, 156122193, 174848149, 489493242, 12775684, 300963748, 912088};
