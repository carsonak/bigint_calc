...
// {
// 	bignum *output = bn_modulus(NULL, NULL);

// 	cr_expect(zero(ptr, output));
// }

// Test(null_inputs, test_1_modulo_null,
...
// 	num1.num = in1;
// 	bignum *output = bn_modulus(&num1, NULL);

// 	cr_expect(zero(ptr, output));
// }

// Test(null_inputs, test_null_modulo_1,
...
// 	num2.num = in2;
// 	bignum *output = bn_modulus(NULL, &num2);

// 	cr_expect(zero(ptr, output));
// }

// Test(null_inputs, test_0_modulo_null,
...
// Test(null_inputs, test_null_modulo_0,
...
// Test(null_inputs, test_minus1_modulo_null,
// 	 .description = "-1 % NULL = NULL", .timeout = 2.0)
// {
// 	uint in1[] = {1};
...
// Test(null_inputs, test_null_modulo_minus1,
// 	 .description = "NULL % -1 = NULL", .timeout = 2.0)
// {
// 	uint in2[] = {1};
...
// Test(zero_len_arrays, test_null_modulo_largenum,
...
// 	 .description = "0 / 0 = NULL", .timeout = 2.0)
// {
// 	uint in1[] = {0}, in2[] = {0};
...
// 	 .description = "1 / 0 = NULL", .timeout = 2.0)
// {
// 	uint in1[] = {1}, in2[] = {0};
...
// Test(negative_modulus, test_neg_9107428777003_modulo_neg_809754437,
// 	 .description = "-9,107,428,777,003 % -809,754,437 = -120,624,064",
// 	 .timeout = 2.0)
// {
// 	uint in1[] = {428777003, 9107}, in2[] = {809754437}, out[] = {120624064};
...
// 	 .description = "-9,107,428,777,003 % 809,754,437 = 689,130,373",
// 	 .timeout = 2.0)
// {
// 	uint in1[] = {428777003, 9107}, in2[] = {809754437}, out[] = {689130373};
...
// 	 .timeout = 2.0)
// {
// 	uint in1[] = {0, 1}, in2[] = {50000}, out[1] = {0};
...
// 	 .description = "50,000 % 1,000,000,000 = 50,000",
// 	 .timeout = 2.0)
// {
// 	uint in1[] = {50000}, in2[] = {0, 1}, out[] = {50000};
...
// 	 .description = "2100,550005550,0,45000,5,65000 % 75006,0 = 285,65000",
// 	 .timeout = 2.0)
// {
// 	uint in1[] = {65000, 5, 45000, 0, 550005550, 2100};
// 	uint in2[] = {0, 75006};
// 	uint rem[] = {65000, 285};
...
// 	 .description = "o_1k.b % o_1k.c = large3", .timeout = 2.0)
// {
...
Test(large_modulus, test_o500d_modulo_o500e,
	 .description = "o_500.d % o_500.e = medium_large3",
	 .timeout = 2.0)
{
...
// Test(large_modulus, test_o100a_modulo_o100f, .description = "o_100.a % o_100.f = long_num", .timeout = 2.0)
// {
// 	uint in1[] = {502884197, 643383279, 62, 0, 0, 0, 0, 222550000, 972222222, 999999999, 338499999, 112000333, 111111111, 28347111, 0, 0, 0, 289104938, 487298347, 832000092, 94, 284000000, 576231637, 28, 0, 57349857, 0, 0, 698750000};
// 	uint in2[] = {0, 101000000, 555555555, 295555555, 9574, 0, 0, 684800000, 252449427, 2, 0, 94930300, 13103309, 99070958, 766};
// 	uint out[] = {502884197, 528383279, 54469664, 289382844, 236557835, 876778715, 905030941, 233307056, 991024687, 674279893, 935667396, 976411137, 700189127, 670035691, 302};
...
// Test(large_modulus, test_o100f_modulo_o100a, .description = "o_100.f % o_100.a = long_num2", .timeout = 2.0)
// {
// 	uint in1[] = {0, 101000000, 555555555, 295555555, 9574, 0, 0, 684800000, 252449427, 2, 0, 94930300, 13103309, 99070958, 766};
// 	uint in2[] = {502884197, 643383279, 62, 0, 0, 0, 0, 222550000, 972222222, 999999999, 338499999, 112000333, 111111111, 28347111, 0, 0, 0, 289104938, 487298347, 832000092, 94, 284000000, 576231637, 28, 0, 57349857, 0, 0, 698750000};
// 	uint out[] = {0, 101000000, 555555555, 295555555, 9574, 0, 0, 684800000, 252449427, 2, 0, 94930300, 13103309, 99070958, 766};
