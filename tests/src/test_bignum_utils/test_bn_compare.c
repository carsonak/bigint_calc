...
Test(null_inputs, test_NULL_cmp_NULL,
	 .description = "compare(NULL, NULL) == 0", .timeout = 1.0)
{
	cr_assert(zero(long, bni_compare(NULL, NULL)));
}

Test(null_inputs, test_0_cmp_NULL,
	 .description = "compare(0, NULL) == 0", .timeout = 1.0)
{
	u_int in1[1];

	num1.len = sizeof(in1) / sizeof(*in1);
	num1.num = in1;
	cr_assert(zero(long, bni_compare(&num1, NULL)));
}

Test(null_inputs, test_NULL_cmp_0,
	 .description = "compare(NULL, 0) == 0", .timeout = 1.0)
{
	u_int in1[1];

	num1.len = sizeof(in1) / sizeof(*in1);
	num1.num = in1;
	cr_assert(zero(long, bni_compare(NULL, &num1)));
}

Test(null_inputs, test_1_cmp_NULL,
	 .description = "compare(1, NULL) == 0", .timeout = 1.0)
{
	u_int in1[] = {1};
...
Test(null_inputs, test_NULL_cmp_1,
	 .description = "compare(NULL, 1) == 0", .timeout = 1.0)
{
	u_int in1[] = {1};
...
Test(null_arrays, test_NULL_cmp_nullarray,
	 .description = "compare(NULL, null_array) == 0", .timeout = 1.0)
{
	cr_assert(zero(long, bni_compare(NULL, &num2)));
}

Test(null_arrays, test_nullarray_cmp_NULL,
	 .description = "compare(null_array, NULL) == 0", .timeout = 1.0)
{
	cr_assert(zero(long, bni_compare(&num1, NULL)));
}
...
Test(null_arrays, test_nullarray_cmp_nullarray,
	 .description = "compare(null_array, null_array) == 0", .timeout = 1.0)
{
	cr_assert(zero(long, bni_compare(&num1, &num2)));
}

Test(null_arrays, test_0_cmp_nullarray,
	 .description = "compare(0, null_array) == 1", .timeout = 1.0)
{
	u_int in1[1];

	num1.len = sizeof(in1) / sizeof(*in1);
	num1.num = in1;
	cr_assert(eq(long, bni_compare(&num1, &num2), 1));
}

Test(null_arrays, test_nullarray_cmp_0,
	 .description = "compare(null_array, 0) == -1", .timeout = 1.0)
{
	u_int in2[1];
...
Test(null_arrays, test_1_cmp_nullarray,
	 .description = "compare(1, null_array) == 1", .timeout = 1.0)
{
	u_int in1[] = {1};
...
Test(null_arrays, test_nullarray_cmp_1,
	 .description = "compare(null_array, 1) == -1", .timeout = 1.0)
{
	u_int in2[] = {1};
...
Test(trailing_zeros, test_long0_cmp_short0,
	 .description = "compare(long_array0, short_array0) > 0", .timeout = 1.0)
{
	...
	cr_assert(gt(long, bni_compare(&num1, &num2), 0));
}

Test(trailing_zeros, test_long_cmp_short0,
	 .description = "compare(long_array, short_array0) > 0", .timeout = 1.0)
{
...
Test(trailing_zeros, test_long0_cmp_short,
	 .description = "compare(long_array0, short_array) > 0", .timeout = 1.0)
{
	u_int in1[] = {1, 8272, 3, 4, 12345, 5, 6, 9, 7, 8, 9284, 1098, 38476, 0, 0, 0, 0, 0, 0};
...
Test(compare_arrays, test_0_cmp_0,
	 .description = "compare(0, 0) == 0(equal)", .timeout = 1.0)
{
	u_int in1[1];
	u_int in2[1];
...
Test(compare_arrays, test_1_cmp_1,
	 .description = "compare(1, 1) == 0(equal)", .timeout = 1.0)
{
	u_int in1[] = {1};
	u_int in2[] = {1};
...
Test(compare_arrays, test_1_cmp_0,
	 .description = "compare(1, 0) > 0", .timeout = 1.0)
{
	u_int in1[] = {1};
	u_int in2[1];
...
Test(compare_arrays, test_0_cmp_1,
	 .description = "compare(0, 1) < 0", .timeout = 1.0)
{
	u_int in1[1];
	u_int in2[] = {1};
	...
	cr_assert(lt(long, bni_compare(&num1, &num2), 0));
}
...
Test(compare_long_arrays, test_biglong_cmp_smalllong,
	 .description = "compare(big_long_array, small_long_array) > 0", .timeout = 1.0)
{
	u_int in1[] = {1, 2, 3, 4, 5, 5, 6, 7, 8, 9};
...
Test(compare_long_arrays, test_smalllong_cmp_biglong,
	 .description = "compare(small_long_array, big_long_array) < 0", .timeout = 1.0)
{
...
Test(compare_different_len_arrays, test_long_cmp_short,
	 .description = "compare(long_array, short_array) > 0", .timeout = 1.0)
{
...
Test(compare_different_len_arrays, test_short_cmp_long,
	 .description = "compare(short_array, long_array) < 0", .timeout = 1.0)
{
...
Test(negative_numbers, test_1_cmp_minus1,
	 .description = "compare(1, -1) > 0", .timeout = 1.0)
{
	u_int in1[] = {1};
	u_int in2[] = {1};
