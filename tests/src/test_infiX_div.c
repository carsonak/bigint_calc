...
Test(simple_divisions, test_1000000000_over_50000,
	 ...
	 .timeout = 2.0)
{
	uint32_t in1[] = {0, 1}, in2[] = {50000}, out[] = {20000};
	 ...
	 .timeout = 2.0)
{
	...
	uint32_t out[] = {208916620, 865984055, 999893341, 28005092};
...
Test(negative_divisions, test_minus9107428777003_over_minus809754437,
	 ...
	 .timeout = 2.0)
{
	uint32_t in1[] = {428777003, 9107}, in2[] = {809754437}, out[] = {11247};
...
Test(negative_divisions, test_minus9107428777003_over_809754437,
	 ...
	 .timeout = 2.0)
{
	uint32_t in1[] = {428777003, 9107}, in2[] = {809754437}, out[] = {11248};
...
Test(large_divisions, test_largenum1_over_largenum2,
