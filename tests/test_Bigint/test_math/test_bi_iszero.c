...
{
	tau->num1 =
		(Bigint){.len = 1, .is_negative = false, .num = (udigit_ty[1]){0}};
...
{
	tau->num1 =
		(Bigint){.len = 1, .is_negative = true, .num = (udigit_ty[1]){0}};
...
{
	tau->num1 =
		(Bigint){.len = 1, .is_negative = false, .num = (udigit_ty[1]){1}};
...
{
	tau->num1 =
		(Bigint){.len = 1, .is_negative = true, .num = (udigit_ty[1]){1}};
