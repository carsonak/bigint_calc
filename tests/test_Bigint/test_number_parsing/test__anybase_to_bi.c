...
/* clang-format off */
const Bigint ALL_BASES_EXPECTED = {.len = 18, .num = (udigit_ty[]){346767800, 34560, 564500000, 740000003, 5600036, 64000000, 400054363, 670000032, 139456837, 0, 589230000, 834, 470000000, 376873419, 42, 400000000, 549338663, 169403018}};
/* clang-format on */
