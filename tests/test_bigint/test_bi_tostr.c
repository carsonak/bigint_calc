...
TEST_F(valid_inputs, test_0)
{
	...
	tau->num1 = (bigint){.len = 1, .num = (digit_ty[1]){0}};
...
{
	const char expected[] = "0";
	tau->num1 = (bigint){.len = 5, .num = (digit_ty[5]){0}};
...
TEST_F(valid_inputs, test_longnum)
{
	...
	tau->num1 = (bigint){.len = 10, .num = (digit_ty[10]){0, 9, 8, 7, 6, 5, 4, 3, 2, 1}};
	/* clang-format on */
...
TEST_F(valid_inputs, test_longnum_with_leading_zero)
{
	/* clang-format off */
	const char expected[] = "1000000002000000003000000004000000005000000006000000007000000008000000009000000000";
	tau->num1 = (bigint){.len = 11, .num = (digit_ty[11]){0, 9, 8, 7, 6, 5, 4, 3, 2, 1, 0}};
	/* clang-format on */
...
TEST_F(valid_inputs, test_longnum_with_leading_zeros)
{
	/* clang-format off */
	const char expected[] = "1000000002000000003000000004000000005000000006000000007000000008000000009000000000";
	tau->num1 = (bigint){.len = 13, .num = (digit_ty[13]){0, 9, 8, 7, 6, 5, 4, 3, 2, 1, 0, 0, 0}};
	/* clang-format on */
...
TEST_F(negative_numbers, test_longnum)
{
	...
	/* clang-format on */
	tau->num1.len = 10;
	tau->num1.num = (digit_ty[10]){0, 9, 8, 7, 6, 5, 4, 3, 2, 1};
...
TEST_F(negative_numbers, test_longnum_with_leading_zero)
{
	...
	/* clang-format on */
	tau->num1.len = 11;
	tau->num1.num = (digit_ty[11]){0, 9, 8, 7, 6, 5, 4, 3, 2, 1, 0};
...
TEST_F(negative_numbers, test_longnum_with_leading_zeros)
{
	...
	/* clang-format on */
	tau->num1.len = 13;
	tau->num1.num = (digit_ty[13]){0, 9, 8, 7, 6, 5, 4, 3, 2, 1, 0, 0, 0};
