...
TEST(invalid_inputs, test_NULL)
{
	CHECK_PTR_EQ(_anybase_to_bi(NULL, 10), NULL);
}

TEST(invalid_inputs, test_base0)
{
	numstr input = {.len = 2, .str = "10"};
	CHECK_PTR_EQ(_anybase_to_bi(&input, 0), NULL);
}

TEST(invalid_inputs, test_base1)
{
	numstr input = {.len = 2, .str = "10"};
	CHECK_PTR_EQ(_anybase_to_bi(&input, 1), NULL);
}

TEST(invalid_inputs, test_base37)
{
	numstr input = {.len = 2, .str = "10"};
	CHECK_PTR_EQ(_anybase_to_bi(&input, 37), NULL);
}
...
TEST(invalid_inputs, test_null_str)
{
	...
	CHECK_PTR_EQ(_anybase_to_bi(&input, 10), NULL);
}
...
TEST_F(all_bases, test_base36)
{
	...
	/* clang-format on */
	numstr input = {.len = sizeof(in_str) - 1, .str = in_str};

	tau->output = _anybase_to_bi(&input, 36);
...
TEST_F(all_bases, test_base35)
{
	...
	tau->output = _anybase_to_bi(&input, 35);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base34)
{
	...
	tau->output = _anybase_to_bi(&input, 34);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base33)
{
	...
	tau->output = _anybase_to_bi(&input, 33);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base32)
{
	...
	tau->output = _anybase_to_bi(&input, 32);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base31)
{
	...
	tau->output = _anybase_to_bi(&input, 31);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base30)
{
	...
	tau->output = _anybase_to_bi(&input, 30);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base29)
{
	...
	tau->output = _anybase_to_bi(&input, 29);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base28)
{
	...
	tau->output = _anybase_to_bi(&input, 28);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base27)
{
	...
	tau->output = _anybase_to_bi(&input, 27);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base26)
{
	...
	tau->output = _anybase_to_bi(&input, 26);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base25)
{
	...
	tau->output = _anybase_to_bi(&input, 25);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base24)
{
	...
	tau->output = _anybase_to_bi(&input, 24);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base23)
{
	...
	tau->output = _anybase_to_bi(&input, 23);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base22)
{
	...
	tau->output = _anybase_to_bi(&input, 22);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base21)
{
	...
	tau->output = _anybase_to_bi(&input, 21);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base20)
{
	...
	tau->output = _anybase_to_bi(&input, 20);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base19)
{
	...
	tau->output = _anybase_to_bi(&input, 19);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base18)
{
	...
	tau->output = _anybase_to_bi(&input, 18);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base17)
{
	...
	tau->output = _anybase_to_bi(&input, 17);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base16)
{
	...
	tau->output = _anybase_to_bi(&input, 16);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base15)
{
	...
	tau->output = _anybase_to_bi(&input, 15);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base14)
{
	...
	tau->output = _anybase_to_bi(&input, 14);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base13)
{
	...
	tau->output = _anybase_to_bi(&input, 13);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base12)
{
	...
	tau->output = _anybase_to_bi(&input, 12);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base11)
{
	...
	tau->output = _anybase_to_bi(&input, 11);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base10)
{
	...
	tau->output = _anybase_to_bi(&input, 10);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base09)
{
	...
	tau->output = _anybase_to_bi(&input, 9);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base08)
{
	...
	tau->output = _anybase_to_bi(&input, 8);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base07)
{
	...
	tau->output = _anybase_to_bi(&input, 7);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base06)
{
	...
	tau->output = _anybase_to_bi(&input, 6);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base05)
{
	...
	tau->output = _anybase_to_bi(&input, 5);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base04)
{
	...
	tau->output = _anybase_to_bi(&input, 4);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base03)
{
	...
	tau->output = _anybase_to_bi(&input, 3);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
...
TEST_F(all_bases, test_base02)
{
	...
	tau->output = _anybase_to_bi(&input, 2);
	CHECK(tau->output->len == ALL_BASES_EXPECTED.len);
	CHECK(tau->output->is_negative == ALL_BASES_EXPECTED.is_negative);
	CHECK_BUF_EQ(
		tau->output->num, ALL_BASES_EXPECTED.num,
